...
// для продвинутой версии можно сделать гифку крутящейся монетки, которая потом падает на поверхность и через 3 сек показывать результат.
// сделать иконку приложения на телефон
